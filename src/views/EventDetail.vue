<template>
  <div v-if="event">
    <EventDetailContent :event="event" :isEventToAttend="isEventToAttend" :isEventCrowded="isEventCrowded"></EventDetailContent>
  </div>
  <div v-else>
    <EventDetailContent :event="localStorageEvent" :isEventToAttend="isEventToAttend" :isEventCrowded="isEventCrowded"></EventDetailContent>
  </div>
</template>
